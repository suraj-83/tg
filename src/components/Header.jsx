...
const Header = () => {
    ...
    return (
        <nav className="bg-white shadow-md">
            <div>
                <div className="flex justify-between mr-4 lg:mr-10 items-center">
                <Link to="/">
    <img src="https://www.tgestravel.com/assets/images/logo/tges-logo.png" alt="TGES" className="w-41 m-3" />
</Link>
                    ...
                    <ul className={`fixed inset-0 z-40  bg-white lg:border lg:opacity-95 lg:rounded-r-full lg:items-center transform ${isMobileMenuOpen ? "translate-x-0" : "translate-x-full"} transition-transform duration-300 md:static md:flex md:space-x-6 md:translate-x-0`}>
                        ...
                        <li className="border-b md:border-none"><Link to="/" onClick={closeMobileMenu} className="block pl-4 lg:pb-0 pb-4 text-gray-600 hover:text-gray-900"><SiGooglehome size={22} /></Link></li>
                        <li className="border-b md:border-none"><Link to="/about" onClick={closeMobileMenu} className="block py-4 px-6 text-gray-600 hover:bg-blue-900 hover:opacity-95 hover:text-white">About</Link></li>
                        <li className="relative border-b md:border-none" onMouseEnter={() => setTravelMode(true)} onMouseLeave={() => setTimeout(() => setTravelMode(false), 100)}>
                            <button type="button" className="block w-full py-4 px-4 text-gray-600  hover:bg-blue-900 hover:opacity-95 hover:text-white hover:text-bold text-left md:text-center">
                        ...
                        <li className="relative border-b md:border-none" onMouseEnter={() => setServices(true)} onMouseLeave={() => setTimeout(() => setServices(false), 100)}>
                            <button type="button" className="block w-full py-4 px-6 hover:bg-blue-900 hover:opacity-95 hover:text-white text-gray-600  text-left md:text-center">
                        ...
                        {isLoggedIn ? (
                            ...
                            <div className="flex flex-col md:flex-row items-start md:items-center">
                                <li className="relative border-b md:border-none" onMouseEnter={() => setLogin(true)} onMouseLeave={() => setTimeout(() => setLogin(false), 100)}>
                                    <button type="button" className="block w-full py-4 px-6 text-gray-600 hover:bg-blue-900 hover:opacity-95 hover:text-white text-left md:text-center">
                        ...
                        <li className="border-b rounded-r-full md:border-none hover:bg-blue-900  hover:opacity-95 hover:text-white"><Link to="/contact" onClick={closeMobileMenu} className="block py-4 px-6 text-gray-600 hover:text-white">Contact</Link></li>
                            </div>
                        )}
                    </ul>
