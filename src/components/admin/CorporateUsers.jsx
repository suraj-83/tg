          ...
          {userDetails.map((user) => (
            <div key={user.id} className="bg-white p-4 rounded shadow-md mb-4">
              ...
              <div className="mb-4">
                ...
                {user.address4 && (
                  <p>
                    <strong>Address 4:</strong> {user.address4}
                  </p>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                <p>
                  <strong>First Name:</strong> {user.contactPersonFirstName}
                </p>
                <p>
                  <strong>Second Name:</strong> {user.contactPersonSecondName}
                </p>
                <p>
                  <strong>Last Name:</strong> {user.contactPersonLastName}
                </p>
                <p>
                  <strong>Gender:</strong> {user.contactPersonGender}
                </p>
                <p>
                  <strong>Department:</strong> {user.contactDepartment}
                </p>
              </div>
              ...
              <div className="mb-4">
                ...
                {user.phoneNumber && (
                  <>
                    <p>
                      <strong>Mobile Number:</strong> +{user.countryCode}-
                      {user.stateCode}-{user.phoneNumber}
                    </p>
                  </>
                )}
                {user.landlineNumber && (
                  <>
                    <p>
                      ...
                      {user.landlineCountryCode}-{user.landlineCityCode}-
                      {user.landlineNumber}
                    </p>
                  </>
                )}
