        ...
        <div className="min-h-[90vh] w-full flex items-center justify-center py-16">
            <form onSubmit={handleSubmit} className="bg-blue-100 p-5 rounded-lg flex flex-wrap gap-7 w-full lg:w-1/2 shadow-[0_0_10px_black]">
                ...
                <div>
                    ...
                    <input type="text" id="country" name="country" className={inputClasses} value={formData.country} onChange={handleChange} />
                </div>
                <div>
                    <label htmlFor="contact" className={labelClasses}>Contact No</label>
                    <input type="text" id="contact" name="contact" className={inputClasses} value={formData.contact} onChange={handleChange} />
                </div>
                <div>
                    <label htmlFor="email" className={labelClasses}>Email Address</label>
                    <input type="email" id="email" name="email" className={inputClasses} value={formData.email} onChange={handleChange} />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="datetime-local" id="pick-up-date" name="pickUpDate" className={inputClasses} value={formData.pickUpDate} onChange={handleChange} />
                </div>
                <div>
                    <label htmlFor="pick-up-address" className={labelClasses}>Pick up Address with Landmark / Location</label>
                    <input type="text" id="pick-up-address" name="pickUpAddress" className={inputClasses} value={formData.pickUpAddress} onChange={handleChange} />
                </div>
                <div>
                    <label htmlFor="drop-date" className={labelClasses}>Drop Date & Time</label>
                    <input type="datetime-local" id="drop-date" name="dropDate" className={inputClasses} value={formData.dropDate} onChange={handleChange} />
                </div>
                <div>
                    <label htmlFor="drop-address" className={labelClasses}>Drop Address with Landmark / Location</label>
                    <input type="text" id="drop-address" name="dropAddress" className={inputClasses} value={formData.dropAddress} onChange={handleChange} />
                </div>
                <div>
                    <label htmlFor="cab-duration" className={labelClasses}>Cab Duration i.e. No of Days</label>
                    <input type="number" id="cab-duration" name="cabDuration" className={inputClasses} value={formData.cabDuration} onChange={handleChange} />
                </div>
                <div>
                    <label htmlFor="no-of-cab" className={labelClasses}>No of Cab Required</label>
                    <input type="number" id="no-of-cab" name="noOfCab" className={inputClasses} value={formData.noOfCab} onChange={handleChange} />
                </div>
                <div>
                    <label htmlFor="type-of-cab" className={labelClasses}>Type of Cab Required</label>
                    <input type="text" id="type-of-cab" name="typeOfCab" className={inputClasses} value={formData.typeOfCab} onChange={handleChange} />
                </div>
                <div>
                    <label htmlFor="no-of-persons" className={labelClasses}>No of Person(s) Travelling</label>
                    <input type="number" id="no-of-persons" name="noOfPersons" className={inputClasses} value={formData.noOfPersons} onChange={handleChange} />
                </div>
                <div>
                    <label htmlFor="traveling-with-infant" className={labelClasses}>Traveling with Infant (Below 5 Yrs) / Child (Above 5 Yrs)</label>
                    <select id="traveling-with-infant" name="travelingWithInfant" className={inputClasses} value={formData.travelingWithInfant} onChange={handleChange}>
                        <option>Select</option>
                ...
                <div>
                    ...
                    <textarea id="other-requirements" name="otherRequirements" className={inputClasses} rows="3" value={formData.otherRequirements} onChange={handleChange} ></textarea>
                </div>
                <button type="submit" className="px-4 py-2 w-full bg-blue-500 text-white rounded-md hover:bg-blue-600">Submit</button>
            </form>
        </div>
    );
};
