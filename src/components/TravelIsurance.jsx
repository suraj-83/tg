...
import { createTravelInsurance } from "../redux/slices/travelSlice";
...
const TravelInsuranceForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await dispatch(createTravelInsurance(formData));
  ...
  return (
    ...
    <button type="button" onClick={() => navigate(-1)} className="flex items-center text-blue-900 hover:text-blue-600">
      <svg
